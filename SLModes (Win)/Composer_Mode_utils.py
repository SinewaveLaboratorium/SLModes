...
def play_chord_progression(composer_mode_window, PLAY_STYLE_SETTING, Chord_Progression_Listbox, Chord_Progression_Modes_Listbox, SUSTAIN_SETTING, midiout):
    ...
    if settings.is_playing == False and settings.is_play_stopped == True:
        MN_MIDI.playComposerChords(Chord_Progression_Listbox, Chord_Progression_Modes_Listbox, SUSTAIN_SETTING, style, composer_mode_window, midiout)
