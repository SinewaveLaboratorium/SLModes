...
freboarddpath = resource_path("fretboard.png")
fretboardnotepath = resource_path("fretnote.png")
freboarddpathlarge = resource_path("LargeNote.png")
freboarddpathrootnote = resource_path("Root_Note.png")
freboarddchordnote = resource_path("Chord_Note.png")
freboarddpathopenlarge = resource_path("OpenFret.png")
extendedfreboardpath = resource_path("extended_fretboard.png")
