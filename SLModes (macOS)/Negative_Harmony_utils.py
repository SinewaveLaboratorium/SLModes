            ...
            if Note(root).compare(note) and root_1_found == False:
                ...
                if Scale_2_None == False:
                    ...
                    if (Circle_of_Notes_Rotation_Degree_left == 0 or Circle_of_Notes_Rotation_Degree_left == 6) and Circle_of_Notes_Rotation_Degree_right == None:
                        ...
                        negative_harmony_background.place(x=-3, y=-3)
            ...
            if skip == False:
                for sn in range(1, 7):
                    if UserScale[sn].compare(note):
                        if number == 1:
                            left_notes_index[n].config(fg=(redcolor))
                        elif number == 2:
                            right_notes_index[n].config(fg=(redcolor))
                        if sn == 1:
                            if number == 1:
...
def clearcolors(number):
    ...
    if number == 1:
        Note1L_LEFT.config(fg=("black"))
        Note1R_LEFT.config(fg=("black"))
        Note2L_LEFT.config(fg=("black"))
        Note2R_LEFT.config(fg=("black"))
        Note3L_LEFT.config(fg=("black"))
        Note3R_LEFT.config(fg=("black"))
        Note4L_LEFT.config(fg=("black"))
        Note4R_LEFT.config(fg=("black"))
        Note5L_LEFT.config(fg=("black"))
        Note5R_LEFT.config(fg=("black"))
        Note6L_LEFT.config(fg=("black"))
        Note6R_LEFT.config(fg=("black"))
    elif number == 2:
        Note1L_RIGHT.config(fg=("black"))
        Note1R_RIGHT.config(fg=("black"))
        Note2L_RIGHT.config(fg=("black"))
        Note2R_RIGHT.config(fg=("black"))
        Note3L_RIGHT.config(fg=("black"))
        Note3R_RIGHT.config(fg=("black"))
        Note4L_RIGHT.config(fg=("black"))
        Note4R_RIGHT.config(fg=("black"))
        Note5L_RIGHT.config(fg=("black"))
        Note5R_RIGHT.config(fg=("black"))
        Note6L_RIGHT.config(fg=("black"))
        Note6R_RIGHT.config(fg=("black"))
...
def calculate_inverted_chord_notes(number, Mode__Chords_Listbox, Negative_Chords_Listbox):

    global Circle_of_Notes_Rotation_Degree_left, Circle_of_Notes_Rotation_Degree_right
    global left_notes_index, right_notes_index
    global go_flag

    for i in range(0, Mode__Chords_Listbox.size()):  # for every chord in the original scale
        list_of_inverted_notes = []
        note_count = 0
        for j in range(0, Chord(Mode__Chords_Listbox.get(i)).notes.__len__()):  # for every note in each chord of the original scale
            if number == 1:
                get_original_note_index = getIndex(Chord(Mode__Chords_Listbox.get(i)).notes[j],left_notes_index)
                ...
                get_original_note_index = getIndex(Chord(Mode__Chords_Listbox.get(i)).notes[j], right_notes_index)
            ...
            list_of_inverted_notes.append(Note(inverted_note_name))
            note_count = note_count + 1

            if note_count == Chord(Mode__Chords_Listbox.get(i)).notes.__len__():
                note_count = 0
...
def Open_Negative_Harmony_Mode(Root_in, Scale_in, Root_in_2, Scale_in_2, UserScale, UserScaleBox02, FLAT_SETTING, font_01, color, darkgrey, listbox_color, redcolor, greencolor, negativeharmonybackgroundfile_pos_1, negativeharmonybackgroundfile_pos_2, negativeharmonybackgroundfile_pos_3, negativeharmonybackgroundfile_pos_4, negativeharmonybackgroundfile_pos_5, negativeharmonybackgroundfile_pos_6, negative_harmony_button, negativeharmonybackgroundfile, circle_of_notes_left, circle_of_notes_right, parser, circle_of_notes_options, Chords_02_Listbox_left, Chords_02_Listbox_right, negativeharmonybackgroundfile_pos_1_pos_1, negativeharmonybackgroundfile_pos_1_pos_2, negativeharmonybackgroundfile_pos_1_pos_3, negativeharmonybackgroundfile_pos_1_pos_4, negativeharmonybackgroundfile_pos_1_pos_5, negativeharmonybackgroundfile_pos_1_pos_6, negativeharmonybackgroundfile_pos_2_pos_1, negativeharmonybackgroundfile_pos_2_pos_2, negativeharmonybackgroundfile_pos_2_pos_3, negativeharmonybackgroundfile_pos_2_pos_4, negativeharmonybackgroundfile_pos_2_pos_5, negativeharmonybackgroundfile_pos_2_pos_6, negativeharmonybackgroundfile_pos_3_pos_1, negativeharmonybackgroundfile_pos_3_pos_2, negativeharmonybackgroundfile_pos_3_pos_3, negativeharmonybackgroundfile_pos_3_pos_4, negativeharmonybackgroundfile_pos_3_pos_5, negativeharmonybackgroundfile_pos_3_pos_6, negativeharmonybackgroundfile_pos_4_pos_1, negativeharmonybackgroundfile_pos_4_pos_2, negativeharmonybackgroundfile_pos_4_pos_3, negativeharmonybackgroundfile_pos_4_pos_4, negativeharmonybackgroundfile_pos_4_pos_5, negativeharmonybackgroundfile_pos_4_pos_6, negativeharmonybackgroundfile_pos_5_pos_1, negativeharmonybackgroundfile_pos_5_pos_2, negativeharmonybackgroundfile_pos_5_pos_3, negativeharmonybackgroundfile_pos_5_pos_4, negativeharmonybackgroundfile_pos_5_pos_5, negativeharmonybackgroundfile_pos_5_pos_6, negativeharmonybackgroundfile_pos_6_pos_1, negativeharmonybackgroundfile_pos_6_pos_2, negativeharmonybackgroundfile_pos_6_pos_3, negativeharmonybackgroundfile_pos_6_pos_4, negativeharmonybackgroundfile_pos_6_pos_5, negativeharmonybackgroundfile_pos_6_pos_6, path):
    ...
    if is_negative_harmony_open == False:
        ...
        negative_harmony_window.geometry("730x600+550+400")
        ...
        def update_Circle_of_Notes(number, path):
            ...
            if number == 1:
                ...
                parser.set('usersettings', 'circle_of_notes_left', option1)
                ...
                parser.set('usersettings', 'circle_of_notes_right', option2)
                with open(path, 'w') as configfile:
                    parser.write(configfile)
        ...
        Circle_of_Notes_left = OptionMenu(negative_harmony_window, circle_of_notes_left, *circle_of_notes_options, command=lambda x: update_Circle_of_Notes(1, path))
        ...
        Circle_of_Notes_right = OptionMenu(negative_harmony_window, circle_of_notes_right, *circle_of_notes_options, command= lambda x: update_Circle_of_Notes(2, path))
        ...
        Mode_1_label_left = Label(negative_harmony_window, height=1,width = width_value)
        ...
        Mode_1_label_right = Label(negative_harmony_window, height=1,width = width_value)
        ...
        Mode1_notes_label_left = Label(negative_harmony_window, width = width_value)
        if (Root_in != None and Scale_in != None):
        ...
        Mode1_notes_label_right = Label(negative_harmony_window, width = width_value)
        if (Root_in_2 != None and Scale_in_2 != None):
        ...
        Mode_1_Chords_Listbox_left = Listbox(negative_harmony_window, exportselection=False, height=11,width = width_value, selectbackground='Gray')
        ...
        Mode_1_Chords_Listbox_left.bind('<Double-Button>', lambda event: MN_AUDIO.playchord(chord_ready_to_play))
            
        Mode_1_Chords_Listbox_right = Listbox(negative_harmony_window, exportselection=False, height=11,width = width_value, selectbackground='Gray')
        ...
        Mode_1_Chords_Listbox_right.bind('<Double-Button>', lambda event: MN_AUDIO.playchord(chord_ready_to_play))

        Mode1_chord_notes_label_left = Label(negative_harmony_window, width = width_value)
        Mode1_chord_notes_label_left.place(x=280, y=265)

        Mode1_chord_notes_label_right = Label(negative_harmony_window, width = width_value)
        Mode1_chord_notes_label_right.place(x=280, y=265+y_offset)

        negative_offset_x = 230

        Mode2_chord_notes_label_left = Label(negative_harmony_window, width = width_value)
        ...
        Mode2_chord_notes_label_right = Label(negative_harmony_window, width = width_value)
        ...
        Mode_1_Negative_label_left = Label(negative_harmony_window, height=1,width = width_value)
        ...
        Mode_1_Negative_label_right = Label(negative_harmony_window, height=1,width = width_value)
        ...
        Mode2_notes_label_left = Label(negative_harmony_window, width = width_value)
        ...
        Mode2_notes_label_right = Label(negative_harmony_window, width = width_value)
        ...
        Mode_1_Negative_Chords_Listbox_left = Listbox(negative_harmony_window, exportselection=False, height=11,width = width_value, selectbackground='Gray')
        ...
        Mode_1_Negative_Chords_Listbox_left.bind('<Double-Button>', lambda event: MN_AUDIO.playchord(chord_ready_to_play))


        Mode_1_Negative_Chords_Listbox_right = Listbox(negative_harmony_window, exportselection=False, height=11,width = width_value, selectbackground='Gray')
        ...
        Mode_1_Negative_Chords_Listbox_right.bind('<Double-Button>', lambda event: MN_AUDIO.playchord(chord_ready_to_play))
